...
public class ProcessTestCase extends ActivitiTestCase {
  ...
  @Deployment(resources = "diagrams/EasyBugFilingProcess.bpmn20.xml")
  public void testHappyPath() {
    HashMap<String, Object> variables = new HashMap<String, Object>();
    
    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("EasyBugFilingProcess");
