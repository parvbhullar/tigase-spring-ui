...
public class CoreMemberInfo {
    ...
    // ---------------20110909 sunncy-----------------
    private String uid;
    private String platformeType;
    private String otherEmail;// 其它email
    private String otherName;// 其它名字
    ...
    /**
     * @param platformeType the platformeType to set
     */
    public void setPlatformeType(String platformeType) {
        this.platformeType = platformeType;
    }

    /**
     * @return the platformeType
     */
    public String getPlatformeType() {
        return platformeType;
    }
