...
public interface ConstantAd {
    ...
    enum ShowType {
        ...
        taobao(5, "淘宝"), 
        taobaoTrain(6, "淘宝直通车"),
        AndroidMarket(7, "AndroidMarket"), 
        iPhoneMarket(8, "iPhoneMarket"),
        callPhone(9, "callPhone");
     ...
     * 广告投放平台
     */
    String PLATFORM_IPHONE = "0";
    String PLATFORM_ANDROID = "1";

    /**
     * 广告付费类型 CPC按点击付费
     */
    String AD_PAYMENT_TYPE_CPC = "1";
    /**
     * 广告点击类型 商铺店主默认 CPM 按展示付费
     */
    String AD_PAYMENT_TYPE_CPM = "2";
