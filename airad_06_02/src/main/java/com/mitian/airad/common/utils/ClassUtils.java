...
public abstract class ClassUtils {
     ...
     * 
     * <pre>
     *  ClassUtil.getShortClassNameForObject(Boolean.TRUE) = "Boolean" <br/>
     *  ClassUtil.getShortClassNameForObject(new Boolean[10]) = "Boolean[]" ClassUtil.getShortClassNameForObject(new int[1][2]) = "int[][]"
     * </pre>
     * 
     * </p>
     * 
     ...
     * 
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class) = "Boolean" ClassUtil.getShortClassName(Boolean[].class) = "Boolean[]" <br/>
     *  ClassUtil.getShortClassName(int[][].class) = "int[][]" ClassUtil.getShortClassName(Map.Entry.class) = "Map.Entry"
     * </pre>
     * 
     * </p>
     * 
     ...
     * 
     * <pre>
     *  ClassUtil.getShortClassName(Boolean.class.getName()) = "Boolean" ClassUtil.getShortClassName(Boolean[].class.getName()) = "Boolean[]" <br/>
     *  ClassUtil.getShortClassName(int[][].class.getName()) = "int[][]" ClassUtil.getShortClassName(Map.Entry.class.getName()) = "Map.Entry"
     * </pre>
     * 
     * </p>
     * 
        ...
        if (clazz.isPrimitive()) {
            ...
            if (Double.TYPE.equals(clazz)) {
                return Double.class.equals(fromClass) || Float.TYPE.equals(fromClass) || Float.class.equals(fromClass)
                        || Long.TYPE.equals(fromClass) || Long.class.equals(fromClass)
                        || Integer.TYPE.equals(fromClass) || Integer.class.equals(fromClass)
                        || Byte.TYPE.equals(fromClass) || Byte.class.equals(fromClass) || Short.TYPE.equals(fromClass)
                        || Short.class.equals(fromClass) || Character.TYPE.equals(fromClass)
                        || Character.class.equals((fromClass));
     ...
     */
    protected static final class TypeInfo {
        private Class type;
