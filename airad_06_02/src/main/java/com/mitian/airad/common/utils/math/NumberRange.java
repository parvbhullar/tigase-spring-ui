...
public final class NumberRange extends Range implements Serializable {
    ...
    /**
     * <p>
     * Constructs a new <code>NumberRange</code> using the specified number as both the minimum and maximum in this
     * range.
     * </p>
     * 
     ...
     * </p>
     * <p>
     * The arguments may be passed in the order (min,max) or (max,min). The {@link #getMinimumNumber()} and
     * {@link #getMaximumNumber()} methods will return the correct value.
     * </p>
     * <p>
     * This constructor is designed to be used with two <code>Number</code> objects of the same type. If two objects of
     * different types are passed in, an exception is thrown.
     * </p>
     * 
