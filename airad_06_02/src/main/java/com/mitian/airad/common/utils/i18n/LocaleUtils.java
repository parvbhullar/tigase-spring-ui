...
public abstract class LocaleUtils {
    ...
    private static final LocaleInfo SYSTEM_LOCALE_INFO;
    private static LocaleInfo defaultLocalInfo;
    private static final ThreadLocal CONTEXT_LOCALE_INFO_HOLDER = new ThreadLocal();
    ...
    static {
        ...
        // 取得系统locale和charset。
        SYSTEM_LOCALE_INFO = new LocaleInfo();

        // 设置默认locale和charset。
        defaultLocalInfo = SYSTEM_LOCALE_INFO;
    }
    ...
    public static List calculateBundleNames(String baseName, Locale locale, boolean noext) {
        baseName = StringUtils.defaultIfEmpty(baseName, StringUtils.EMPTY);
    ...
    public static LocaleInfo getDefault() {
        return (defaultLocalInfo == null) ? SYSTEM_LOCALE_INFO : defaultLocalInfo;
    }
    ...
    public static LocaleInfo setDefault(Locale locale) {
        ...
        defaultLocalInfo = new LocaleInfo(locale, null, SYSTEM_LOCALE_INFO);
    ...
    public static LocaleInfo setDefault(Locale locale, String charset) {
        ...
        defaultLocalInfo = new LocaleInfo(locale, charset, SYSTEM_LOCALE_INFO);
    ...
    public static LocaleInfo getContext() {
        LocaleInfo contextLocaleInfo = (LocaleInfo) CONTEXT_LOCALE_INFO_HOLDER.get();
    ...
    public static LocaleInfo setContext(Locale locale) {
        ...
        CONTEXT_LOCALE_INFO_HOLDER.set(new LocaleInfo(locale, null, defaultLocalInfo));
    ...
    public static LocaleInfo setContext(Locale locale, String charset) {
        ...
        CONTEXT_LOCALE_INFO_HOLDER.set(new LocaleInfo(locale, charset, defaultLocalInfo));
    ...
    public static LocaleInfo setContext(LocaleInfo localeInfo) {
        if (localeInfo == null) {
            ...
            CONTEXT_LOCALE_INFO_HOLDER.set(localeInfo);
    ...
    public static void resetContext() {
        CONTEXT_LOCALE_INFO_HOLDER.set(null);
    }
}
