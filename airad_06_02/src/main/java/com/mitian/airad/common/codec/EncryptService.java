...
public interface EncryptService {
     ...
     */
    byte[] encrypt(byte[] plaintext, String algorithm);
     ...
     * @throws EncryptException
     */
    byte[] decrypt(byte[] cryptotext, String algorithm);
     ...
     * @throws EncryptException
     */
    String decrypt(String cryptotext, String algorithm);

    /**
     * 采用encryterName指定的消息摘要器，对message进行消息摘要处理
     * 
     * @param message 需摘要的内容
     * @param algorithm 摘要器名称
     * @throws EncryptException
     */
    byte[] digest(byte[] message, String algorithm);
     ...
     * @throws EncryptException
     */
    boolean matches(byte[] message, byte[] digest, String algorithm);
     ...
     * @throws EncryptException
     */
    String digest(String message, String algorithm);
     ...
     * @throws EncryptException
     */
    boolean matches(String message, String digest, String algorithm);
