...
public abstract class JsonUtils {
     ...
     * @return
     */
    public static List getList4Json(String jsonString, Class pojoClass, String dataFormat) {
        ...
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            String[] dateFormats = new String[]{dataFormat};
     ...
     * @return
     */
    public static String getJsonFromList(List inList) {
