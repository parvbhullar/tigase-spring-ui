...
public class InviteCodeService {
    ...
    @Autowired
    private CoreInviteCodeDAO coreInviteCodeDAO;
    ...
    /**
     * @return the coreInviteCodeDAO
     */
    public CoreInviteCodeDAO getCoreInviteCodeDAO() {
        return coreInviteCodeDAO;
    }

    /**
     * @param coreInviteCodeDAO the coreInviteCodeDAO to set
     */
    public void setCoreInviteCodeDAO(CoreInviteCodeDAO coreInviteCodeDAO) {
        this.coreInviteCodeDAO = coreInviteCodeDAO;
    }
