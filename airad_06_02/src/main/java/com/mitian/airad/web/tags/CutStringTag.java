...
public class CutStringTag extends TagSupport {
     ...
     */
    private static Logger logger = Logger.getLogger(CutStringTag.class);
     ...
     * @return
     */
    public String cutString(String str, int len, String addationMark) {
        len = len * 2;
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (counter > len) {
                ...
                sb = new StringBuffer(result + addationMark);
                break;
            }
            sb.append(curChar);
        }
