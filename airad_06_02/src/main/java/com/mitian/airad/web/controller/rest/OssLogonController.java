...
public class OssLogonController extends AbstractController {
     ...
     */
    private static final String VALID_FAILE = "0";
    private static final String VALID_SUCCES = "1";
    ...
    public String ossLogon4Dev(HttpServletRequest request, HttpServletResponse response) throws IOException,
        ...
        String salesId = "121";
        String memberId = "756";
        String encodeSalesId =
                encryptService.encrypt(salesId, EncryptService.ENCRYPT_ALGORITHM.PBEWithMD5AndDES.name());
        String encodeMemberId =
                encryptService.encrypt(memberId, EncryptService.ENCRYPT_ALGORITHM.PBEWithMD5AndDES.name());
        ...
        CookieUtils.setCookieAfterOssLogon(response, encodeSalesId, encodeMemberId, encryptedCurTime);
        return "oss/logon";
    }
    ...
    public String ossLogon(HttpServletRequest request, HttpServletResponse response) throws IOException,
        ...
        if (deploymentContextService.isOSSDeployType()) {
            ...
            if (VALID_SUCCES.equals(validResult)) {
                ...
                getLogger().error("oss logon faile with salesId: " + decodeSalesId + "  membrId :" + decodeMemberId);
                return "oss/error";
            }
        }
        else {
