 ...
 * @param {Object} uiId
 */
function initCallPhone(uiId){

    var $taobao2 = $("." + uiId + "CallPhone");
    
    //修改表单输入控件名称
    $taobao2.find(".CallPhoneNumber").attr("id",uiId+"CallPhoneNumber");
    //修改表单隐藏id
    
    $taobao2.find(".CallPhoneId").attr("id",uiId+"CallPhoneId");
