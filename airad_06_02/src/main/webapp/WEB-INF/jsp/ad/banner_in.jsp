...
<button id="bannerDraftSave" type="button" style="cursor:pointer">保存Banner</button>
 <span class="gray collapsed">|</span> 
 <a href="javascript:void(0)" id="exhibitBanner" style="display:none"><img width="14" height="14" alt="展开" src="/images/ico_infoc.gif">展开</a>
 <a href="javascript:void(0)" id="closeBanner" ><img width="14" height="14" alt="收起" src="/images/ico_infoo.gif">收起</a>
  </div>
 </div>
广告 Banner 制作
...
<div class="popCon">
<div class="tag">
  <a class="now selectModelByType" tag="5" color="black" href="javascript:void(0)">纯文字</a>
	<a href="javascript:void(0)" tag="6" color="red" class="selectModelByType">小图加文字</a> 
	<a href="javascript:void(0)" tag="7" color="red" class="selectModelByType">大图加文字</a>
	<a href="javascript:void(0)" color="blue" tag="8" class="selectModelByType">小图加动态文字</a>
	<a href="javascript:void(0)" tag="9" color="green" class="selectModelByType">用户自定义</a>
     </div>
<div class="colorBox">
