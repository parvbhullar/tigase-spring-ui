...
<div class="leftCon">
<h1>应用程序修改</h1>
<form:form action="app.do?action=doAdd&currentPage=${form.currentPage}" method="post" commandName="command">
<form:hidden path="app.appId"/>
<form:hidden path="app.memberId"/>
<form:hidden path="appPlatformType"/>
<form:hidden path="app.appCode"/>
<form:hidden path="downLoad"/>
<table border="0" cellspacing="0" cellpadding="0" class="tabNF">
        <col width="30%" />
        <col width="70%" />
        <tr>
          <th><span class="must"></span>应用ID</th>
          <td>${form.app.appCode}</td>
        </tr>
        <tr>
