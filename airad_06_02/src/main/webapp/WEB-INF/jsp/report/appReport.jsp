...
<div class="tag">
<a class="now" href="javascript:void(0);" onclick="getChar(this)" id="sunAsk" tabindex="1">总请求数/次</a> 
<a href="javascript:void(0);" onclick="getChar(this)" id="sunShow" tabindex="2">总展示数/次</a>
<a href="javascript:void(0);" onclick="getChar(this)" id="sunClick" tabindex="3">总点击数/次</a>
<a href="javascript:void(0);" onclick="getChar(this)" id="sunClickCost" tabindex="4">总收入/元</a>  
</div>
<div class="borderBox">
<div id="show">
