 ...
 *
 *
 * @version $Id: TimeZonesHandle.java,v 1.2 2007-11-28 11:13:24 nichele Exp $
 */
public abstract class TimeZonesHandle {
     ...
     * @param utc the utc can be '2008-2-28' or 20080223T123000Z or 20080223T123000
     * @return if the utc equals '2008-2-28' return   '2008-2-28'
     * 2008-02-28 17:55
     */
    public String UTCConvertLocalTime(String utc) {
        String lt = "";
        if (utc.indexOf("-") > -1) {
            return utc;
        } else {
            try {
                ...
                if (utc.indexOf("Z") > -1) {
                    len = utc.length() - 1;
                    lt = utc.substring(0, utc.indexOf("T")) + utc.substring(utc.indexOf("T") + 1, len);
                    lt = lt.substring(0, 4) + "-" + lt.substring(4, 6) + "-" + lt.substring(6, 8) + " " + lt.substring(8, 10) + ":" + lt.substring(10, 12) + ":" + lt.substring(12, 14);
                    try {
                        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                        Date date = format.parse(lt);
                        format.setTimeZone(TimeZone.getTimeZone("GMT+16"));
                        lt = format.format(date);
