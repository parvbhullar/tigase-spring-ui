...
public class NumberUtils {
     ...
     * be used as <code>NumberUtils.stringToInt("6");</code>.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * If the string starts with <code>0x</code> or <code>-0x</code>, it will be interpreted as a hexadecimal integer. Values with leading
                ...
                case 'L' :
                    if (dec == null && exp == null
                        ...
                        try {
                            ...
                            logger.error("数字格式错误" + nfe.getMessage());
                        }
    ...
    /**
     * Integer类型数据做NULL安全处理，将NULL转化为0
     * 
     * @param value
     * @return
     */
    public static Integer trimNullToZero(Integer value) {
        if (value == null) {
            return INTEGER_ZERO;
        }
        return value;
