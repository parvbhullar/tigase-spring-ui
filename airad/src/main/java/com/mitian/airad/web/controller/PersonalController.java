...
public class PersonalController extends AbstractController {
    ...
    @RoleAuthority({RoleFactory.ROLE_ALL})
    public ModelAndView index(PersonalForm form, HttpServletRequest request) throws Exception {
        ...
        if (role.isAdvAndDev() || role.isDev()) {
            ...
            if (RoleFactory.CURRENT_ROLE_TYPE_DEV.equals(roleTypes)) {
                return personaldevList(form, request);
            }
            return personalList(form, request);
        }
    ...
    public ModelAndView personalList(PersonalForm form, HttpServletRequest request) throws ServletException,
            NotLogonException {
        ...
        String adcount = statAd.getShowNum() == null ? "0" : statAd.getShowNum().toString();
    ...
    public ModelAndView personaldevList(PersonalForm form, HttpServletRequest request) throws ServletException,
            NotLogonException {
