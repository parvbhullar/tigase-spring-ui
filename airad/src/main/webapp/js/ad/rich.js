    ...
    if (oldNum < Number(num)) {
        for (var i = oldNum; i < num; i++) {
            ...
            if (objLi.next().html() == null) {
                objLi.before("<li class='spanAdRich' value='99'><span class='fr'><sup>&yen;</sup><span class='content singlefree'>0</span></span>子页面" + (Number(i) + 1) + "</li>");
            }
            else {
              ...
              var  type = data.getAttribute("type");
                if (type == '1') {
                    ...
                    if ($("#marketType").val()=="1") {
                        ...
                        $myIfram.find("#phoneIco").removeClass("androidBtn");
                         $myIfram.find("#bj").removeClass("androidBg");
