...
<h2><img
	...
	id="closePop2"
	alt="关闭"
	src="images/ico_popclose.gif">子页面模板选择</h2>
<div class="popCon">
<table
	cellspacing="0"
	cellpadding="0"
	...
	<tr>
		...
		<span class="pBoxCon">纯文字
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='1' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon">图文
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='2' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon">相册
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='3' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon">地图
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='4' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon">淘宝商品
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='5' /></span>
		</c:if>
		</span>
...
<!--		</a>-->
		...
		<span class="pBoxCon">淘宝直链
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='6' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon">安卓应用
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='7' /></span>
		</c:if>
		</span>
		...
		<span class="pBoxCon"><strong style="font-size:9px;font-weight:normal">iPhone</strong>应用
			<c:if test="${!baseRole.ossSales}">
		<span class="sml"><sup>&yen;</sup><airad:sysConfig type='SHOW_TYPE' flag='out' key='8' /></span>
		</c:if>
		</span>
	...
	<tr>
		...
		<div class="btnBox"><a
			...
			class="btnY fl"><span>提交</span></a></div>
		</td>
	</tr>
</table>
</div>
