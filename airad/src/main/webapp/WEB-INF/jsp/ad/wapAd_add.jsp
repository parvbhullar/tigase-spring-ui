...
<form:form name="myfrm" action="ad.do?action=addWapAd" commandName="command"  method="post">
 <table border="0" cellspacing="0" cellpadding="0" class="tabNF">
        ...
        <tr>
          ...
          <input type="hidden" name="campaignId" value="${command.wap.campaignId }" />
           <form:hidden path="wap.adGroupId"/>
           <form:hidden path="wap.campaignId"/>
         </td>
        </tr>
 </table>  
 <h4>Wap 制作</h4>
...
<ul>
  <li><span class="fr"></span>名称:${cag.getAdGroupName()}</li>
</ul>
<h2><img src="images/ico_gup.gif" alt="活动" width="16" height="16"
  align="absmiddle" />广告摘要</h2>
<ul>

  <li>名称: <form:label path="wap.adName"></form:label> </li>
  <li>Wap 标题:<form:label path="wap.wapTitle"></form:label><br /> </li>
  <li>联系地址: <form:label path="wap.contactAddress"></form:label></li>
</ul>
