...
<c:choose>
  ...
  <c:otherwise>
      <a href="/report.do?action=edit&reportId=${form.report.reportId }" class="btnS fr"><span>修改此报表</span></a>
      <h1 class="tit">
...
<!--<a href="javascript:void(0);" onclick="getChar(this)" id="cost" tabindex="3">展示成本</a>  -->
<a href="javascript:void(0);" onclick="getChar(this)" id="cost" tabindex="3">点击率</a>  
<a href="javascript:void(0);" onclick="getChar(this)" id="avgClick" tabindex="4">点击成本</a>
</div>
<div class="borderBox">
