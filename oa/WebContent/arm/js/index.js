...
Ext.onReady(function() {
	...
	var closeButton = new Ext.Button({
				...
				renderTo : 'closeDiv',
				handler : function() {
					window.location.href = 'login.xzb?reqCode=logout';
				}
			});
	...
	function unlockSystem() {
		...
		Ext.Ajax.request({
					url : 'index.xzb?reqCode=unlockSystem',
	...
	function saveUserTheme(o) {
		showWaitMsg();
		Ext.Ajax.request({
			url : './index.xzb?reqCode=saveUserTheme',
		...
		userWindow.on('show', function() {
					setTimeout(function() {
								userFormPanel.form.load({
											...
											url : 'index.xzb?reqCode=loadUserInfo',
	...
	function updateUser() {
		...
		userFormPanel.form.submit({
					url : 'index.xzb?reqCode=updateUserInfo',
					waitTitle : '提示',
					method : 'POST',
					waitMsg : '正在处理数据,请稍候...',
					success : function(form, action) {
