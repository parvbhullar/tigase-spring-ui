...
//System.out.println("ASCII=" + ascii);
    ...
    public static String getSpellByAscii(int ascii) {
        ...
        if (ascii < -20319 || ascii > -10247) { //不知道的字符
            ...
            return "xx";//String.valueOf(random.nextInt(100));
        }
    ...
    public static void main(String[] args) {
        String str = null;
        str = "谢海普降喜雨";
        System.out.println("Spell=" + CnToSpellTools.getFirstSpell(str));

        str = "张牙舞爪";
        System.out.println("Spell=" + CnToSpellTools.getFullSpell(str));
