...
import com.ivyinfo.framework.common.tools.StringTools;
...
/**
 * @version $Id: XMLToHashMapTools.java,v 1.2 2007-11-28 11:13:24 nichele Exp $
 */
public class XMLToHashMapTools {
    ...
    public static void main(String args[]) throws Exception {
        ...
        XMLToHashMapTools s = new XMLToHashMapTools();
    ...
    public static String hashMapToXml(Map fields) throws Exception {
        ...
        while (i.hasNext()) {
            ...
            fieldValue = escapeBasicXml((String) fields.get((String) fieldName));
     ...
     * @see #unescapeXml(java.lang.String)
     **/
    private static String escapeBasicXml(String str) {
        if (str == null) {
            return null;
        }
