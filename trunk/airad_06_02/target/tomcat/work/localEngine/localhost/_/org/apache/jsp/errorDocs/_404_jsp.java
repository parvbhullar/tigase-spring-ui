package org.apache.jsp.errorDocs;
...
memberInfo=context.getMemberInfo();
  ...
  request.setAttribute("baseRole",baseRole);
      ...
      out.write("<div class=\"infoTip long\">\n");
      out.write("<h1>您访问的信息已失效。</h1>\n");
      out.write("<p>您现在可以：</p>\n");
      out.write("<ul>\n");
      out.write("  <li><a href=\"/\">返回网站首页</a></li>\n");
      out.write("  <li><a href=\"member.do?action=queryMember\">回到会员中心</a></li>\n");
      out.write("</ul>\n");
      out.write("</div>\n");
      out.write("</div>\n");
      out.write("</div>\n");
