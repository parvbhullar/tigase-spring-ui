...
<button class="pageDraftSave" type="button" style="cursor:pointer;display: none">
<span style="display: none"></span>保存此广告页</button>
<span style="display: none" class="gray">|</span> 
  <a href="javascript:void(0)"class="exhibitRich" style="display: none">
  <img style="display: none" src="/images/ico_infoc.gif" alt="展开" width="14" height="14" />展开</a>
	<a href="javascript:void(0)" class="closeRich" style="display: none">
	<img style="display: none" src="/images/ico_infoo.gif" alt="收起" width="14" height="14" />收起</a> 
	
	<span style="display: none" class="gray">|</span>

<a class="previewRichShow" href="javascript:void(0)">预览</a></span></div>
广告内容制作<span class="pnum"></span> <%
     //隐藏hidden
...
<!--	</tr>-->
	...
	<tr class="trMap collapsed">
		...
		<td>
		<div class="mb">
		<button class="addPoint" type="button" onclick="javascript: $('#adIsModifed').val('1');"><span
	...
	<tr class="trTaobaoDemo collapsed">
		<th>淘宝商品ID</th>
		<td><input class="short numIID" onchange="javascript: $('#adIsModifed').val('1');" maxlength="15" /> <a
...
<!--	<tr class="trMarketIphone1 collapsed">-->
<!--		<th>号码</th>-->
<!--		<td>-->
<!--		  <input type="hidden" class="marketIponeId">-->
<!--		</td>-->
<!--	</tr>-->
	</tbody>
	
	<tr class="trCallPhone collapsed">

      <th><span class="must">*</span>联系电话 <input type="hidden" class="CallPhoneId"/></th>
      <td><input class="CallPhoneNumber" type="text" class="small" maxlength="20" />
    <br /><small>输入的只能为  电话号码 格式</small>
    </td>
