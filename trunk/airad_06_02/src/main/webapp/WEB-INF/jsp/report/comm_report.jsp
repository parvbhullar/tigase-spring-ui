...
<table border="0" cellspacing="0" cellpadding="0" class="tabNF">
  ...
  <tr>
    ...
    <td><!-- 活动 ，广告组，广告-->
       <c:choose>
          ...
          -->
			      <form:radiobutton value="1" path="report.reportType" label="广告组报告 " onclick="loadData(this)" checked="true"/>
  ...
  <tr>
    <th rowspan="2">时间</th>
    <td><form:radiobutton path="report.dateType" value="1" onclick="chooseDate(this);" checked="true"/>
    ...
    <tr><td><form:radiobutton path="report.dateType" value="0" onclick="chooseDate(this);" />
       日期范围:
        <form:input path="reportStartTime" class="cal" readonly="true" disabled="true" />-
        <form:input path="reportEndTime" class="cal"  readonly="true" disabled="true"/>
  ...
  <c:choose>
      ...
      <tr>
       <th>&nbsp;</th>
       <td><form:checkbox path="report.reportFlag" value="0" label="显示已删除的广告组和广告" checked="true" onclick="filterDel(this)"/></td>
      </tr>
      </c:when>
       <c:when test="${form.flag==2}">
	       <tr>
