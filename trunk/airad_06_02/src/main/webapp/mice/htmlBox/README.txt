...
HtmlBox 2.8 is a Cross-browser interactive open-source
HTML textarea built on top of the jQuery library.
Tested with Mozilla Firefox, Inrernet Explorer, Opera,
Netscape and Safari..

HtmlBox ver. 2.8 is distributed under the MIT license
...
For usage instrictions on how to use this product see
