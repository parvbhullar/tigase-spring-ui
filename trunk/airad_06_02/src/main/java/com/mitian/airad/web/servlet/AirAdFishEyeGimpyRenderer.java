...
/**
 * AirAdFishEyeGimpyRenderer.java 没有横轴竖轴线的鱼眼版本
 * 
 * @author baojun
 */
public class AirAdFishEyeGimpyRenderer implements GimpyRenderer {
    private final Color _hColor;
    private final Color _vColor;

    public AirAdFishEyeGimpyRenderer() {
        this(Color.BLACK, Color.BLACK);
    }

    public AirAdFishEyeGimpyRenderer(Color hColor, Color vColor) {
        _hColor = hColor;
        _vColor = vColor;
    }
