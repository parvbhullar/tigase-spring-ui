...
public class CoreAdGroup {
    ...
    private int suspendY;

    private int suspendN;

    private int approveNum;

    private int notblockingNum;
    ...
    public int getSuspendN() {
        return suspendN;
    }

    public void setSuspendN(int suspendN) {
        this.suspendN = suspendN;
    }
    ...
    public void setAdLocalType(String adLocalType) {
        this.adLocalType = adLocalType;
    }
    ...
    public int getNotblockingNum() {
        return notblockingNum;
    }

    public void setNotblockingNum(int notblockingNum) {
        this.notblockingNum = notblockingNum;
    }
