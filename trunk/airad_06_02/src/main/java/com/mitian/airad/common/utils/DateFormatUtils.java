...
public abstract class DateFormatUtils {
    ...
    public static final FastDateFormat ISO_DATETEMP_FORMAT = FastDateFormat.getInstance("yyyy-MM-dd HH:mm:ss");

    public static final FastDateFormat ZH_DATE_FORMAT = FastDateFormat.getInstance("yyyy年MM月dd日");

    public static final FastDateFormat ZH_DATETIME_FORMAT = FastDateFormat.getInstance("yyyy年MM月dd日 HH时mm分ss秒");
    /**
