...
public class CoreAdGroupDAOImpl extends CustomSqlMapClientDaoSupport implements CoreAdGroupDAO {
    ...
    public List<CoreAdGroup> findAllGroupByWithOutMemberId(Long memberId) {
        ...
        key.setMemberId(memberId);
        List<CoreAdGroup> coreAdGroupList =
                getSqlMapClientTemplate().queryForList("CORE_AD_GROUP.ibatorgenerated_selectAllGroupByWithOutMemberId", key);
        return coreAdGroupList;
    }
    ...
    public int findCountDefaultGroup(Map<String, String> params) {
        int count = 0;
        Integer c = (Integer) getSqlMapClientTemplate().queryForObject("CORE_AD_GROUP.findCountDefaultGroup", params);
        if (null != c) {
            count = c.intValue();
        }
        return count;
    ...
    public int findCountDefaultAd(Map<String, String> params) {
        int count = 0;
        Integer c = (Integer) getSqlMapClientTemplate().queryForObject("CORE_AD_GROUP.findCountDefaultAd", params);
        if (null != c) {
            count = c.intValue();
        }
        return count;
    ...
    public void updateAdSuspendType(Map<String, String> params) {
        int rows = getSqlMapClientTemplate().update("CORE_AD_GROUP.updateAdSuspendType", params);
    }

    /*
     * (non-Javadoc)
     * @see com.mitian.airad.dao.CoreAdGroupDAO#selectGroupListByMemberId()
     */
    public List<CoreAdGroup> selectGroupListByMemberId(Long memberId) {
        return getSqlMapClientTemplate().queryForList("CORE_AD_GROUP.ibatorgenerated_selectGroupListByMemberId",
                memberId);
    }
}
