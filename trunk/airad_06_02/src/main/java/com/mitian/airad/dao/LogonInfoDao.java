...
public interface LogonInfoDao {
     ...
     * @param logonInfo
     */
    void insert(LogonInfo logonInfo);
     ...
     * @return
     */
    LogonInfo getLogonInfo(String decodeCookieId, String decodeSessionId);
     ...
     * @param sessionId
     */
    void deleteByCookieIdAndSessionId(String cookieId, String sessionId);
