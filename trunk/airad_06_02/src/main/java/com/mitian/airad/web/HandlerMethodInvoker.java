...
import com.mitian.airad.web.form.AbstractForm;
...
public class HandlerMethodInvoker {
    ...
    public final Object invokeHandlerMethod(Method handlerMethod, Object handler, NativeWebRequest webRequest,
        ...
        try {
            ...
            for (String attrName : methodResolver.getActualSessionAttributeNames()) {
                Object attrValue = sessionAttributeStore.retrieveAttribute(webRequest, attrName);
                if (attrValue != null) {
     ...
     * @throws Exception
     */
    private void validate(Object[] args) throws Exception {
        if (args == null || args.length == 0) {
            return;
        }
        for (Object obj : args) {
            if (obj instanceof AbstractForm) {
                AbstractForm baseForm = (AbstractForm) obj;
                if (null == baseForm.getErrors()) {
                    baseForm.setErrors(new LinkedHashMap<String, String>());
                }
                Map<String, String> noticeMessages =
                        validationService.validate(baseForm, baseForm.getAction(), Locale.CHINESE);
                if ((noticeMessages != null) && !noticeMessages.isEmpty()) {
                    baseForm.getErrors().putAll(noticeMessages);
                }
            }
        }
    }
    ...
    public final void updateModelAttributes(Object handler, Map<String, Object> mavModel,
        ...
        if (methodResolver.hasSessionAttributes() && sessionStatus.isComplete()) {
            for (String attrName : methodResolver.getActualSessionAttributeNames()) {
                sessionAttributeStore.cleanupAttribute(webRequest, attrName);
            }
        }
            ...
            try {
                ...
                for (String attrName : originalAttrNames) {
                    ...
                    boolean isSessionAttr =
                            methodResolver.isSessionAttribute(attrName, (attrValue != null ? attrValue.getClass()
                                    : null));
                    if (isSessionAttr) {
    ...
    protected void initBinder(Object handler, String attrName, WebDataBinder binder, NativeWebRequest webRequest)
        ...
        if (bindingInitializer != null) {
            bindingInitializer.initBinder(binder, webRequest);
        }
        if (handler != null) {
            Set<Method> initBinderMethods = methodResolver.getInitBinderMethods();
    ...
    private Object resolveRequestParam(String paramName, boolean required, String defaultValue,
            MethodParameter methodParam, NativeWebRequest webRequest, Object handlerForInitBinderCall) throws Exception {
    ...
    protected Object resolveRequestBody(MethodParameter methodParam, NativeWebRequest webRequest, Object handler)
        ...
        return readWithMessageConverters(methodParam, createHttpInputMessage(webRequest), methodParam
                .getParameterType());
    }
    ...
    private Object readWithMessageConverters(MethodParameter methodParam, HttpInputMessage inputMessage, Class paramType)
        ...
        if (contentType == null) {
            ...
            throw new HttpMediaTypeNotSupportedException("Cannot extract parameter (" + builder.toString()
    ...
    private Class<?> getHttpEntityType(MethodParameter methodParam) {
        ...
        throw new IllegalArgumentException("HttpEntity parameter (" + methodParam.getParameterName()
    ...
    private WebDataBinder resolveModelAttribute(String attrName, MethodParameter methodParam,
        ...
        else if (methodResolver.isSessionAttribute(name, paramType)) {
            bindObject = sessionAttributeStore.retrieveAttribute(webRequest, name);
            if (bindObject == null) {
    ...
    protected Object resolveCommonArgument(MethodParameter methodParameter, NativeWebRequest webRequest)
        ...
        if (customArgumentResolvers != null) {
            for (WebArgumentResolver argumentResolver : customArgumentResolvers) {
