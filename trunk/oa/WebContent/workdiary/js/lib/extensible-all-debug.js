...
Ext.ensible.cal.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({'Urgency': rec.data[Ext.ensible.cal.EventMappings.CalendarId.name]});
        }
...
Ext.ensible.cal.EventEditWindow = Ext.extend(Ext.Window, {
    ...
    initComponent: function(){
        ...
        this.fbar = ['->',{
            id:this.id+'-delete-btn', text:this.cancelButtonText, disabled:false, handler:this.onCancel, scope:this, hideMode:'offsets'
        }];
