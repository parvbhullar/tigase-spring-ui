...
Ext.onReady(function() {
	...
	var deptTree = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : 'userPart.xzb?reqCode=departmentTreeInit'
						}),
				root : root,
				title : '',
				applyTo : 'deptTreeDiv',
	...
	var store_part = new Ext.data.Store({
				...
				proxy : new Ext.data.HttpProxy({
							url : 'userPart.xzb?reqCode=queryParts'
						}),
				reader : new Ext.data.JsonReader({
							totalProperty : 'TOTALCOUNT',
							root : 'ROOT'
	...
	var menuTreePanel = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
							baseAttrs : {},
							dataUrl : 'part.xzb?reqCode=queryMenuItems'
						}),
				root : root,
	...
	function saveData() {
		...
		Ext.Ajax.request({
					url : 'userPart.xzb?reqCode=savePartUserGrantDatas',
