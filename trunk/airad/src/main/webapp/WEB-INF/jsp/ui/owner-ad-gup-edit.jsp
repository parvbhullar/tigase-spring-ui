...
<div id="main">
<div class="mainCon">
<h1><span>广告管理 &raquo; <a href="index.php">活动管理</a> &raquo; <a href="owner-ad-gup.php"><img src="images/ico_act.gif" alt="活动" width="16" height="16" align="absmiddle" />宣传米田科技有限公司...</a> &raquo;</span> <img src="images/ico_gup.gif" alt="广告组" width="16" height="16" align="absmiddle" />佳能单反相关广告</h1>
  <div class="leftCon">
  <h1>编辑广告组</h1>
  ...
  <tr>
    ...
    <div>最低<select name="select2">
        ...
        <tr>
          ...
          <td>
          <div class="btnBox">
           <a href="owner-ad-detail.php" class="btnY fl"><span>提交</span></a>
