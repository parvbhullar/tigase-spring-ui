...
YAHOO.widget.Node.prototype = {
    ...
    */
     ...
     * @param oParent {Node} this node's parent node
     * @param expanded {boolean} the initial expanded/collapsed state
     * @TODO i changed this method add a param oIndex
     */
    init: function(oData, oParent, expanded, oIndex) {
 ...
 * @param expanded {boolean} the initial expanded/collapsed state
     * @TODO i changed this method add a param oIndex
 */
YAHOO.widget.TextNode = function(oData, oParent, expanded, oIndex) {

    if (oData) { 
        this.init(oData, oParent, expanded, oIndex);
