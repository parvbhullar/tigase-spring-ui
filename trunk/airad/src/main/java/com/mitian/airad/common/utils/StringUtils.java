...
public class StringUtils {
     ...
     * </p>
     * <p>
     * This is the only StringUtils method that uses the <code>isSpace</code> definition. You are advised to use
     * {@link #deleteWhitespace(String)} instead as whitespace is much better localized.
     * </p>
     * 
     * <pre>
     ...
     * </pre>
     * <p>
     * Spaces are defined as <code>{' ', '\t', '\r', '\n', '\b'}</code> in line with the deprecated <code>isSpace</code>
     * method.
     * </p>
     * 
     ...
     * @deprecated Use the better localized {@link #deleteWhitespace(String)}. Method will be removed in Commons Lang
     *             3.0.
     */
    @Deprecated
    ...
    public static String overlay(String str, String overlay, int start, int end) {
        ...
        return new StringBuffer(len + start - end + overlay.length() + 1).append(str.substring(0, start)).append(
                overlay).append(str.substring(end)).toString();
    }
     ...
     * @return the reversed String, <code>null</code> if null String input
     * @deprecated Use {@link #reverseDelimited(String, char)} instead. This method is broken as the join doesn't know
     ...
     */
    /*
     * private static int min(int a, int b, int c) { // Method copied from NumberUtils to avoid dependency on subpackage
