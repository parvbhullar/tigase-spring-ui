...
public class LibTaobao {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((taobaoUrl == null) ? 0 : taobaoUrl.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (taobaoUrl == null) {
            if (other.taobaoUrl != null) {
                return false;
            }
        }
        else if (!taobaoUrl.equals(other.taobaoUrl)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "LibTaobao [id=" + id + ", richId=" + richId + ", status=" + status + ", taobaoUrl=" + taobaoUrl + "]";
    }
