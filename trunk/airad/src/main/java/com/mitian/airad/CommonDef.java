...
public interface CommonDef {
    ...
    public interface rechargeHisType {
        /**
         * 0银联充值，1代理商为广告商充值 2收益转换 3支付宝 4优惠券充值 5平台(广告) 6平台（开发者）
         */
    ...
    public interface CVSTB {
         ...
         * cvs 表头信息
         */
        String DrawMoneyID = "序号";
        String DrawMoneySerialId = "提现流水号";
        String DrawMoney = "提现金额";
        String Status = "受理状态";
        String DrawTime = "提现充值时间";
        /**
         * 处理数据显示信息
         */
        String STATUS1 = "受理中";
