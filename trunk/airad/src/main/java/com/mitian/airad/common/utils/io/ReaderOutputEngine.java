...
/**
 * 将数据从任意<code>Reader</code>复制到<code>OutputStreamWriter</code>的输出引擎. 本代码移植自IBM developer works精彩文章, 参见package文档.
 * 
 * @author zhoufengbo
 */
public class ReaderOutputEngine implements OutputEngine {
    ...
    public void open(OutputStream out) throws IOException {
        if (writer != null) {
            ...
            writer =
                    (encoding == null) ? new OutputStreamWriter(factory.getOutputStream(out)) : new OutputStreamWriter(
