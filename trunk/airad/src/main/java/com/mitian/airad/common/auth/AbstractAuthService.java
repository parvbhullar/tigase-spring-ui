...
public abstract class AbstractAuthService implements AuthService {
     ...
     * @return
     */
    private String getEncryptedUserId(AuthenticationToken auth) throws EncryptException {
     ...
     */
    private void addCookie(HttpServletResponse response, String encryptUserId) throws EncryptException {
    ...
    protected abstract AuthenticationToken doAuthentication(AuthenticationToken token) throws AuthException;
}
