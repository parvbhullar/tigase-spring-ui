...
public class PropertiesUtils {
    ...
    public static final int getInt(Properties props, String key, int defaultValue) throws IllegalArgumentException {
        String strValue = getString(props, key, null);
        int value;
    ...
    public static final long getLong(Properties props, String key, long defaultValue) throws IllegalArgumentException {
        String strValue = getString(props, key, null);
        long value;
