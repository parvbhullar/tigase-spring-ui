...
<html>
	...
	<script>
		...
		*/  
		...
		// 初始化
		function init(){
			document.getElementById('ratio').value="${active.ratio}";
		}
	</script>
	<body onLoad="init()">
  			...
  			<tr>
    			...
    			<td valign="top" background="../images/content-bg.gif">
    				<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
			      		<tr>
			        		<td height="31"><div class="titlebt">修改活动</div></td>
			      		</tr>
    				</table>
    			</td>
        						...
        						<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
					          		<tr>
					            		<td height="8">
					            			<table width="100%">
					            				<tr>
					            					<td class="left_txt">当前位置：&nbsp;>>&nbsp;修改活动</td>
          								...
          								<td>
											...
											<table style="width:100%">
												<tr>
													...
													<td style="width:35%"><input type="text" name="acttitle" id="acttitle" value="${active.acttitle}" maxlength=64></td>
													<td style="width:15%" style="text-align:right">活动地点：</td>
													<td style="width:35%"><input type="text" name="actaddr" id="actaddr" value="${active.actaddr}" maxlength=64></td>
												</tr>
												<tr>
													<td style="width:15%" style="text-align:right">开始日期：</td>
													<td style="width:35%"><input type="text" name="startdate" id="startdate" onfocus="WdatePicker();" value="${active.startdate}"/></td>
													<td style="width:15%" style="text-align:right">结束日期：</td>
													<td style="width:35%"><input type="text" name="enddate" id="enddate" onfocus="WdatePicker();" value="${active.enddate}"/></td>
												</tr>
												<tr>
													<td style="width:15%" style="text-align:right">活动人数：</td>
													<td style="width:35%"><input type="text" name="actnum" id="actnum" value="${active.actnum}" maxlength=8></td>
													<td style="width:15%" style="text-align:right">活动系数：</td>
													<td style="width:35%">
														<select style="width:20%" name="ratio">
												...
												<tr>
													...
													<td style="width:35%" colspan=3>
														<textarea name="summary" id="summary" rows=3 cols=40>${active.summary}</textarea>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td colspan=3><input type="file" name="enclosure" id="enclosure" size="50" /></td>
												</tr>
											</table>
											<div align="center">
												<!-- 活动ID -->
												...
												<!-- 附件 -->
												<input type="hidden" name="path" value="${active.path}">
												<!-- 修改标志 -->
												<input type="hidden" name="editFlag" value="1">
												<input type="button" name="btnSave" value="保 存" onClick="saveIssueActive()">&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="button" name="btnReset" value="重 置">			
											</div>
											</form>
          								</td>
          							</tr>
