        						...
        						<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
					          		<tr>
					            		<td height="8">
					            			<table width="100%">
					            				<tr>
					            					<td class="left_txt">当前位置：&nbsp;>>&nbsp;短信列表</td>
          							...
          							<tr>
            							<td>
           									<table width="100%" border="1" cellspacing="0" cellpadding="0" id="orgtypetabletree">
           										<thead>
													<tr>
														<th width="20%" class="left_txt2">手机号</th>
														<th width="10%" class="left_txt2">活动ID</th>
														<th width="10%" class="left_txt2">短信内容</th>
														<th width="10%" class="left_txt2">回复时间</th>
													</tr>
												</thead>	
												<tbody>
													<c:forEach var="tiMthis" items="${tiMthisList}" varStatus="status">
													<td align="center">${tiMthis.dstid }</td>
													<td align="center">${tiMthis.actid }</td>
													<td align="center">${tiMthis.msgcontent }</td>
													<td align="center">${tiMthis.retrytimes }</td>
														</tr>
													</c:forEach>
												</tbody>
           									</table>
