	...
	<body >
  			...
  			<tr>
    			...
    			<td valign="top" background="../images/content-bg.gif">
    				<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
			      		<tr>
			        		<td height="31"><div class="titlebt">修改帮扶</div></td>
			      		</tr>
    				</table>
    			</td>
        						...
        						<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
					          		<tr>
					            		<td height="8">
					            			<table width="100%">
					            				<tr>
					            					<td class="left_txt">当前位置：&nbsp;>>&nbsp;修改帮扶</td>
		...
		<table style="width:100%">
			...
			<tr>
				...
				<td style="width:35%"><input type="text" name="HName" id="HName" value="${worksheet.HName}" maxlength=64 readonly></td>
				<td style="width:15%" style="text-align:right">帮扶地点：</td>
				<td style="width:35%"><input type="text" name="HAddress" id="HAddress" value="${worksheet.HAddress}" maxlength=64></td>
			</tr>


			<tr>
				<td style="width:15%" style="text-align:right">志愿者姓名：</td>
				<td style="width:35%"><input type="text" name="VName" id="VName" value="${worksheet.VName}" maxlength=64 readonly>
				<a href="javascript:void(0)" id="searchp">匹配志愿者</a>
				</td>
				<td style="width:15%" style="text-align:right">志愿者联系电话：</td>
				<td style="width:35%"><input type="text" name="VTel" id="VTel" value="${worksheet.VTel}" maxlength=64 readonly></td>
			</tr>

			
			<tr>
				<td style="width:15%" style="text-align:right">帮扶主题：</td>
				<td colspan=3><input type="text" name="HTitle" id="HTitle" value="${worksheet.HTitle}" maxlength=200 size=100></td>
			</tr>
			
			<tr>
				<td style="width:15%" style="text-align:right">开始日期：</td>
				<td style="width:35%"><input type="text" name="HStartdate" value="${worksheet.HStartdate}" id="HStartdate" onfocus="WdatePicker();"/></td>
				<td style="width:15%" style="text-align:right">结束日期：</td>
				<td style="width:35%"><input type="text" name="HOverdate" value="${worksheet.HOverdate}" id="HOverdate" onfocus="WdatePicker();"/></td>
			</tr>
			...
			<input type="hidden" name="worksheetno" value="${worksheet.worksheetno}" />
			<input type="hidden" name="HAreaid"  value=${currentOrgId} />
			<input type="hidden" name="VAreaid" id="VAreaid" value="${worksheet.VAreaid}" />
			<input type="hidden" name="HTypeid" id="HTypeid" value="${worksheet.HTypeid}" />
			<input type="hidden" name="state" value="0" />		
			<input type="hidden" name="adminid" value="${worksheet.adminid}" />
			<input type="hidden" name="isdel" value="1" />
			<input type="hidden" name="sysValue" id="sysValue"  value="0" />								
			<input type="hidden" name="id" id="v_id"  value="${worksheet.id}" />	
		</table>
		<div align="center">
