	...
	<script>
		// 分页
	  	function goPage(page){
	  	  	document.location='/zyz/manage/helping/helpList.action?page='+page + '&selectOrgId=' + document.getElementById('selectOrgId').value;
	  	}
	</script>
	<body>
  			...
  			<tr>
    			...
    			<td valign="top" background="../images/content-bg.gif">
    				<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
			      		<tr>
			        		<td height="31"><div class="titlebt">帮扶列表</div></td>
			      		</tr>
    				</table>
    			</td>
        						...
        						<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
					          		<tr>
					            		<td height="8">
					            			<table width="100%">
					            				<tr>
					            					<td class="left_txt">当前位置：&nbsp;>>&nbsp;统计管理>>帮扶统计</td>
          							...
          							<tr>
            							<td>
            								<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0" class="nowtable">
              									<tr>
                									<td class="left_bt2">&nbsp;&nbsp;&nbsp;&nbsp;${orgName}&nbsp;${startdate}~${enddate}&nbsp;一览</td> 
          							...
          							<tr>
            							<td>
           									<table width="100%" border="1" cellspacing="0" cellpadding="0" id="orgtypetabletree">
           										<thead>
													<tr>
														<th width="20%" class="left_txt2">帮扶主题</th>
														<th width="10%" class="left_txt2">开始日期</th>
														<th width="10%" class="left_txt2">结束日期</th>
														<th width="20%" class="left_txt2">组织名称</th>
														<th width="10%" class="left_txt2">管理操作</th>
													</tr>
												</thead>	
												<tbody>
													<c:forEach var="active" items="${helpingList}" varStatus="status">
													<c:if test="${(status.count-1) % 2 ==0 }">
														<tr height="10" bgcolor="#f2f2f2" id="${active.worksheetid}" class="child-of-${active.worksheetid}">
														
													</c:if>
													<c:if test="${(status.count-1) % 2 !=0}">
														<tr height="10" id="${active.worksheetid}" class="child-of-${active.worksheetid}">
													</c:if>
													<td align="center">${active.HTitle }</td>
													<td align="center">${active.HStartdate }</td>
													<td align="center">${active.HOverdate }</td>
													<td align="center">${orgName }</td>
													<td align="center"><a href="/zyz/manage/helping/worksheetDetail.action?id=<c:url value="${active.worksheetid}"/>" class="class_query" id="query">查 看</a></td>
